 ...
 * 
 */
class SolarLite_Mail_Transport_Adapter_Smtp extends SolarLite_Mail_Transport_Adapter
{
    /**
     * 
     ...
     * 
     */
    public function setSmtp(SolarLite_Smtp $smtp)
    {
        $this->_smtp = $smtp;
    }
