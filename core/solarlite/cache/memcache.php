 ...
 * 
 */
class SolarLite_Cache_Memcache extends SolarLite_Cache
{
    /**
     * 
    ...
    protected $_config = array(
        ...
        'port' => 11211,
        'timeout' => 1,
        'flag' => null, // MEMCACHE_COMPRESSED as possible option
        'pool' => array(),
    );
    ...
    /**
     * 
     * construction tasks to complete object construction.
     * 
     * @return void
     * 
     */
    ...
    public function save($key, $data, $life = null)
    {
        ...
        // store in memcache
        return $this->memcache->set($key, $data, $this->_config['flag'], $life);
    }
    ...
    public function add($key, $data, $life = null)
    {
        ...
        // add to memcache
        return $this->memcache->add($key, $data, $this->_config['flag'], $life);
    }
     ...
     * 
     */
    public function addLong($key, $data, $life = 86400)
    {
        return $this->add($key, $data, $life); // 1 day
    }
    ...
    public function increment($key, $amt = 1)
    {
        ...
        $this->add($key, 0, $this->_config['flag'], $this->_life);
     ...
     * 
     * Data is replaced in the cache server for the given key. If the key does
    ...
    public function replace($key, $data, $life = null)
    {
        ...
        return $this->memcache->replace($key, $data, $this->_config['flag'], $life);
    }
