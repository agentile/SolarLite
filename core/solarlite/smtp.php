...
class SolarLite_Smtp {
    ...
    protected function _exception($type, $data)
    {
        $data = (array) $data;
        throw SolarLite_Exception(array('text' => $type, 'info' => $data));
        trigger_error("$type: " . var_export($data, true), E_USER_WARNING);
    }
}
